<div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						<a href="<?php echo base_url() ?>supplier/tambah" class="btn btn-info btn-sm">Tambah Data Baru</a>
                            <br>
		...
		?>
                                        ...
                                        <tr class="odd gradeX">
                                         ...
                                         <td>
										 <a href="<?=base_url('supplier/edit/'.$u->id_supplier)?>"  class="fa fa-fw fa-pencil"></a> &nbsp;
										<a href="<?=base_url('supplier/hapus/'.$u->id_supplier)?>" onclick="return konfirmasi()" class="fa fa-fw fa-bitbucket"></a>
										</td>
											</tr>
											<?php } ?>
