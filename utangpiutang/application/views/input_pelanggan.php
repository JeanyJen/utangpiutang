                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="<?php echo base_url(). 'pelanggan/tambah_aksi'; ?>" method="post" role="form">
                                        
                                        <div class="form-group">
                                            <label>Nama Pelanggan</label>
                                            <input class="form-control" name="nama_pelanggan" maxlength="30" required placeholder="Nama Pelanggan">
                                        </div>
