...
<body class="bg-dark" class="hold-transition login-page" style="background-image: url(<?=base_url('images/gambar1.jpeg');?>);background-position: fixed; background-repeat: no-repeat; background-size: cover;">
