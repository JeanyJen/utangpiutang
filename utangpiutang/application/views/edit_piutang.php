                        ...
                        <div class="panel-body">
                            <div class="row">
								...
								<?php  foreach($piutang as $u){ ?>
                                    <form action="<?php echo base_url(). 'piutang/update'; ?>" method="post" role="form">
                                        
                                        <div class="form-group">
                                            <label>No Transaksi</label>
											 <input class="form-control" type="hidden" name="id_piutang" value="<?php echo $u->id_piutang?>">
										...
										<div class="form-group">
											...
											<input class="form-control" type="hidden" name="id_piutang" value="<?php echo $u->id_piutang?>">
                                            <input class="form-control" id="txt1" onkeyup="sum();" onkeypress="return isNumberKeyTrue(event)" name="piutang_awal" maxlength="20" required value="<?php echo $u->piutang_awal?>"">
                                        </div>
										
										<div class="form-group">
                                            <label>Jumlah Bayar</label>
											<input class="form-control" type="hidden" name="id_piutang" value="<?php echo $u->id_piutang?>">
                                            <input class="form-control" id="txt2" onkeyup="sum();" onkeypress="return isNumberKeyTrue(event)" name="jumlah_bayar" maxlength="20" required value="<?php echo $u->jumlah_bayar?>">
                                        </div>
										
										<div class="form-group">
                                            <label>Sisa Piutang</label>
											<input class="form-control" type="hidden" name="id_piutang" value="<?php echo $u->id_piutang?>">
                                            <input class="form-control" id="txt3" onkeyup="sum();" onkeypress="return isNumberKeyTrue(event)" name="sisa_piutang" maxlength="20" required value="<?php echo $u->sisa_piutang?>">
										</div>
										
										<div class="form-group">
                                            <label>Tanggal Jatuh Tempo</label>
											<input class="form-control" type="hidden" name="id_piutang" value="<?php echo $u->id_piutang?>">
                                            <input class="form-control" type="date"  name="tanggal_jatuh_tempo" required value="<?php echo $u->tanggal_jatuh_tempo?>">
											<input class="form-control" type="hidden" id="txt4" onkeyup="sum();"  name="keterangan" maxlength="20" value="<?php echo $u->keterangan?>">
                                        </div>
